...
BEGIN
    ...
    IF expected_holidays_count1 != actual_holidays_count1 THEN
        raise_application_error(-20001, 'Test failed: expected_holidays_count1 = ' || expected_holidays_count1 ||
                                '; actual_holidays_count1: ' || actual_holidays_count1);
    END IF;
    IF expected_holidays_count2 != actual_holidays_count2 THEN
        raise_application_error(-20001, 'Test failed: expected_holidays_count2 = ' || expected_holidays_count2 ||
